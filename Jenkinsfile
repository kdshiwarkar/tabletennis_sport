    ...
    stages {
        ...
        stage('Container creation') {
         ...
         stage('Copy war file to container') {
            steps {
              sh 'docker cp /home/kunalshiwarkar/.jenkins/workspace/tabletennis_sport/target/tabletennis_sport.war kunalcont1:/opt/download/apache-tomcat-9.0.91/webapps'
         }
        }
